 ...
 * Usage:
 *
 * <nic-tab @tab-change="onClickTab">
 *      <nic-tab-item title="oneTabTitle">
 *          ...
 *      </nic-tab-item>
 *      <nic-tab-item title="twoTabTitle" active>
 *          ...
 *      </nic-tab-item>
 * </nic-tab>
 *
 * <nic-tab @tab-change="onClickTab">
 *      <nic-tab-item title="some" v-bind:active="isSomeTabActive">
 *          ...
 *      </nic-tab-item>
 * </nic-tab>
 *
...
var NicTabs = {
  ...
  mounted: function() {
    ...
    that.tabs.map(function(tab, index) {
        if (u.isDef(tab.$attrs.active) && tab.$attrs.active) {
...
var NicTabsPlugin = {
  install: function install(Vue) {
    Vue.component('nic-tab', NicTabs);
    Vue.component('nic-tab-item', NicTab); // 'n-tab'
  }
};

if (typeof module !== 'undefined') {
  module.exports = NicTabsPlugin;
} else if (typeof window !== 'undefined' && window.Vue) {
  window.Vue.use(NicTabsPlugin);
}
